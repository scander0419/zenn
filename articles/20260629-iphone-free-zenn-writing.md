...
Safari で github.com を開き、リポジトリ上で直接ファイルを作ります。

1. `articles/` で「Add file」→「Create new file」
2. ファイル名を `20260629-xxx.md`（slug ルールを守る）
3. テンプレの中身を貼り付け、front matter と本文を埋める
4. 下部の「Commit changes」で **「Create a new branch and start a pull request」** を選ぶ
5. そのまま PR 作成まで完了
